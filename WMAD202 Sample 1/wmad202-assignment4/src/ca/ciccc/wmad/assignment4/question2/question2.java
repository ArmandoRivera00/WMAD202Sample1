// Write a method which lets the user enter English words. The user can keep entering English words as long as the user
// has not entered the word "exit". Once the user enters "exit" the method will return and print the list of all
// distinct words that start with English.
